...
/mob/living/carbon/human/proc/change_iconbase(new_iconbase, owner_sensitive)
	for(var/obj/item/organ/external/O in bodyparts)
		O.change_organ_iconbase(new_iconbase, owner_sensitive) //Change the iconbase of all our organs. If owner_sensitive is set, that means the proc won't mess with frankenstein limbs.
